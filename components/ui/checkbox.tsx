...
// Tell NativeWind to treat the Root and Indicator like standard styled Views
...
function Checkbox({
  ...
  return (
    <CheckboxPrimitive.Root
      className={cn(
        "border-input dark:bg-input/30 size-4 rounded-[0px] border shadow-sm shadow-black/5",
        Platform.select({
